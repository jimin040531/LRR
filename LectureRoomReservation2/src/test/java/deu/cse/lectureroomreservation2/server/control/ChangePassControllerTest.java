...
public class ChangePassControllerTest {
    ...
    private static final Path USER_FILE = Paths.get("src/test/resources/UserInfo.txt");
    private static final Path BACKUP_FILE = Paths.get("src/test/resources/UserInfo_backup.txt");
    ...
    public void testChangePassSuccess() {
        String result = controller.changePassword("20212977", "1234", "5678");
